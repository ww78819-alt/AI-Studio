      ...
      <AnimatePresence>
        {!activeWindow && isLoaded && (
          ...
          >
            ...
            {/* Page 3: About Me */}
            <section className="relative w-full h-screen snap-start flex flex-col items-center justify-center px-8 md:px-24 bg-[#fafafa] overflow-hidden pt-24 md:pt-32 pb-32 md:pb-48">
